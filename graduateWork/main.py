...
def main():
    ...
    class Data:
        ...
        K_min=float(input("Значение коэффициента теплопередачи при теплообмене от жидкости к жидкости: ") or 800)
    ...
    print("Тепловая нагрузка Q = {:.3f} кВт".format(Q / 1000))

    # Получение площади поверхности

    F = Q / (data.K_min * t_avr)          # м2
    print("Максимальная величина площади поверхнолсти: {:.2f} м2".format(F))
